...
datafile = '8-16-2018 D005 Test Data';
rawdata = xlsread(datafile, 1, 'B49:AW4524');
protocolfile = '8-16-2018 D005 Test Protocol.xlsx';
...
% extract antibiotic inhibitor concentrations
...
blanksaveragesmoothed = movmean(blanksaverage, 5);
...
controlsaveragesmoothed = movmean(controlsaverage, 5);
