...
datafile = '2-22-2022 CLA summary.xlsx';

data = readmatrix(datafile, 'Sheet', 1, 'Range', 'F:I'); % fraction OD GFP BFP
...
%         set(gca, 'FontSize', 20)
% 
%         %saveas(f, strcat(strainnames(i), " ", num2str(abxconcentrations(j)), " AMX Averages"), 'jpeg')
%     end
% end
% 
% %close all
...
% ylabel("Resistant Fraction")
% %legend('Periplasmic', 'Cytoplasmic', 'Location', 'southeast', 'FontSize', 24)
% %legend('boxoff')
% set(gca, 'FontSize', 24)
% 
% %high copy
...
% %xlabel("CLA (\mug/mL)")
% %ylabel("Resistant Fraction")
% %legend('Periplasmic', 'Cytoplasmic', 'Location', 'northwest', 'FontSize', 24)
% %legend('boxoff')
% set(gca, 'FontSize', 30)
% 
% %close all
...
% datasplit format: timepoints, abxconcentration, inhconcentration, strain,
% replicate, [fraction OD GFP BFP]
...
%         set(gca, 'FontSize', 20)
%         
%         %saveas(f, strcat(strainnames(i), " ", num2str(abxconcentrations(j)), " AMX Replicates"), 'jpeg')
%     end
% end
% 
% % close all
