...
% check to see whether you can do anything about the fact that the median
% filter kills the beginning of the growth curves
...
ncontrols = 128;
datastartsrow = 5;
growththreshold = 0.1; %%%%%%% change this as needed
rawinterval = height + datastartsrow;

% read in raw data from excels
datafile = '8-8-2018 BlaM Test Data';
rawdata = xlsread(datafile, 1, 'B49:AW4524');
protocolfile = '8-8-2018 BlaM Test Protocol.xlsx';
