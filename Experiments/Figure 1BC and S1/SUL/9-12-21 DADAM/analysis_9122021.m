...
strainname = 'DA28102 + DA28102 Low Copy BlaM';

% read in raw data from excel
datafile = '9-12-2021 Data.xlsx';
...
layoutfile = '9-12-2021 Protocol.xlsx';
...
% testcondition1 = conditionsdata{73};
% 
% % plot a specific condition
% figure(2);
% plot(timepoints, testcondition1, 'k');
% xlabel("Hours");
% ylabel("OD");
% ylim([0 1.5]);
% xlim([0 24]);
...
%% heatmap
% 
plottimepoints = [4 8 16 24];
for hour = plottimepoints
