...
isolatenames = ["DICON149", "DICON168", "DICON169", "DICON174", "DICON175", "DICON178", "DICON179", "DICON181"];

% read in raw data from excel
datafile = '10-5-2020 DICON149 DICON181 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '10-5-2020 DICON149 DICON181 Protocol.xlsx';
