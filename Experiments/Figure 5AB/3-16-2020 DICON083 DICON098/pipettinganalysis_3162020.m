...
isolatenames = ["DICON083", "DICON085", "DICON088", "DICON090", "DICON091", "DICON092", "DICON097", "DICON098"];

% read in raw data from excel
datafile = '3-16-2020 DICON083 DICON098 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-16-2020 DICON083 DICON098 Protocol.xlsx';
