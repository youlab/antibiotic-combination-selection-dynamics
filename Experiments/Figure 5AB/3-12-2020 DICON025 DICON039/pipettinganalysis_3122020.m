...
isolatenames = ["DICON025", "DICON026", "DICON029", "DICON031", "DICON032", "DICON035", "DICON036", "DICON039"];

% read in raw data from excel
datafile = '3-12-2020 DICON025 DICON039 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-12-2020 DICON025 DICON039 Protocol.xlsx';
