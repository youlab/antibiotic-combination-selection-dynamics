...
isolatenames = ["2535", "2545", "2546", "2547", "2556", "2560", "2567", "2590"];

% read in raw data from excel
datafile = '2-5-2020 2535 2590 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '2-5-2020 2535 2590 Protocol.xlsx';
...
save('2535 2590', 'isolatedata', 'isolateGRs', 'isolatenames');