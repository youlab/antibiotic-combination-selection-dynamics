...
isolatenames = ["6168", "6180", "1026002848", "1026002900", "1026002871", "1026002719", "1026002784", "1026002806"];

% read in raw data from excel
datafile = '3-8-2020 6168 1026002806 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-8-2020 6168 1026002806 Protocol.xlsx';
