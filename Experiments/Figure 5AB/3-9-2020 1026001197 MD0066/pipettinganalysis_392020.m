...
isolatenames = ["1026001197", "1011002087A", "1026000655", "MD0018", "MD0030", "MD0040", "MD0062", "MD0066"];

% read in raw data from excel
datafile = '3-9-2020 1026001197 MD0066 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-9-2020 1026001197 MD0066 Protocol.xlsx';
