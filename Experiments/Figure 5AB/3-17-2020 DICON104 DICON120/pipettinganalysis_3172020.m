...
isolatenames = ["DICON104", "DICON107", "DICON094", "DICON109", "DICON110", "DICON112", "DICON113", "DICON120"];

% read in raw data from excel
datafile = '3-17-2020 DICON104 DICON120 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-17-2020 DICON104 DICON120 Protocol.xlsx';
