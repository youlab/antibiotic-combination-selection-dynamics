...
isolatenames = ["DICON040", "DICON041", "DICON043", "DICON044", "DICON045", "DICON047", "DICON048", "DICON049"];

% read in raw data from excel
datafile = '3-14-2020 DICON040 DICON049 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-14-2020 DICON040 DICON049 Protocol.xlsx';
