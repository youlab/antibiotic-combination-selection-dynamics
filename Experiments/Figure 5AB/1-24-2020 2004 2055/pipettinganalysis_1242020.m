...
isolatenames = ["2004", "2005", "2007", "2009", "2039", "2045", "2050", "2055"];

% read in raw data from excel
datafile = '1-24-2020 2004 2055 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '1-24-2020 2004 2055 Protocol.xlsx';
...
%GRs
for i = 1:nisolates   
    figure(str2double(isolatenames(i))+30000)
    hold on
...
% ODs
for i = 1:nisolates 
    figure(str2double(isolatenames(i))+40000)
    hold on
