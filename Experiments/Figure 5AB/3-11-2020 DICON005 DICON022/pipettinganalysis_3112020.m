...
isolatenames = ["DICON005", "DICON006", "DICON007", "DICON016", "DICON018", "DICON019", "DICON021", "DICON022"];

% read in raw data from excel
datafile = '3-11-2020 DICON005 DICON022 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-11-2020 DICON005 DICON022 Protocol.xlsx';
