...
isolatenames = ["DICON124", "DICON126", "DICON128", "DICON135", "DICON39", "DICON141", "DICON142", "DICON146"];

% read in raw data from excel
datafile = '10-4-2020 DICON124 DICON146 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '10-4-2020 DICON124 DICON146 Protocol.xlsx';
