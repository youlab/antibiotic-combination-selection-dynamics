...
isolatenames = ["DICON053", "DICON054", "DICON055", "DICON057", "DICON058", "DICON060", "DICON064", "DICON082"];

% read in raw data from excel
datafile = '3-15-2020 DICON053 DICON082 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-15-2020 DICON053 DICON082 Protocol.xlsx';
