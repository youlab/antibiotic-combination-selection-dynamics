...
isolatenames = ["MD0073", "MD0088", "MD0116", "MD0117", "MD0144", "MD0189", "DICON001", "DICON003"];

% read in raw data from excel
datafile = '3-10-2020 MD0073 DICON003 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '3-10-2020 MD0073 DICON003 Protocol.xlsx';
