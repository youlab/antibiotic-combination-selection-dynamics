...
isolatenames = ["2597", "2604", "2606", "2609", "2612", "2614", "2620", "2627"];

% read in raw data from excel
datafile = '2-9-2020 2597 2627 Data.xlsx';
rawdata = readmatrix(datafile, 'Sheet', 1, 'Range', 'D54:NW198')';
timedata = readmatrix(datafile, 'Sheet', 1, 'Range', 'B54:B198');

layoutfile = '2-9-2020 2597 2627 Protocol.xlsx';
...
for i = 1:nisolates
    ...
    fig = figure(str2double(isolatenames(i))+10000);
    hold on
...
for i = 1:nisolates
    ...
    fig = figure(str2double(isolatenames(i)));
    hold on
...
for i = 1:nisolates
    ...
    fig = figure(str2double(isolatenames(i))+20000);
    hold on
...
%GRs
for i = 1:nisolates   
    fig = figure(str2double(isolatenames(i))+30000);
    hold on
...
% ODs
for i = 1:nisolates 
    fig = figure(str2double(isolatenames(i))+40000);
    hold on
...
save('2597 2627', 'isolatedata', 'isolateGRs', 'isolatenames');