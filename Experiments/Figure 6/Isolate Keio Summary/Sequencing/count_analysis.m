...
avgnormalizedconditiondata = squeeze(mean(normalizedconditiondata, 5));
...
for i = 1:length(rstrainnames)-1
    ...
    % bl = repb.BaseLine;
    % bl.Visible = 'off';
    % saveas(f, strcat(rstrainnames(i), " no labels"), 'jpg');
end
...
for i = 5:6
    ...
    % bl = repb.BaseLine;
    % bl.Visible = 'off';
    % saveas(f, strcat("Keio ", num2str(i), " no labels"), 'jpg');
end
...
for i = 1:length(rstrainnames)-1
    ...
    bl = repb.BaseLine;
    bl.Visible = 'off';
    saveas(f, strcat(rstrainnames(i), " initial no labels"), 'jpg');
end
...
for i = 5:6
    ...
    bl = repb.BaseLine;
    bl.Visible = 'off';
    saveas(f, strcat("Keio ", num2str(i), " initial no labels"), 'jpg');
end
