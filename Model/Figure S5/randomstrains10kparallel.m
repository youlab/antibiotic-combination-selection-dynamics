...
parfor k = 1:nstrains   % for each strain
    ...
    kappab = 6*rand();   % antibiotic degradation by extracellular Bla
    phimax = 6*rand();   % antibiotic degradation by resistant cells
    ...
    db = 1+9*rand();   % degradation/inhibition of extracellular Bla (0-6)
